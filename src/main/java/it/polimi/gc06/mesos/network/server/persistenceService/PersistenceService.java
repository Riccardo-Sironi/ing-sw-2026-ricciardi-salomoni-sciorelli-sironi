...
public class PersistenceService implements Runnable{
    ...
    public PersistenceService() throws IOException {
        ...
        try{
            ...
            Map<Integer,GameSnapshot> snapshotMap = mapper.readValue(backupFile, new TypeReference<Map<Integer,GameSnapshot>>() {});
            //creates registry
            ...
            //TODO: activate this error message only if the file wasn't empty
            System.err.println("[PersistenceService] Error while trying to load from backup file...");
            e.printStackTrace();
        }
    }
